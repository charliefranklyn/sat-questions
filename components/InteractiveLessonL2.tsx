...
<div style={{ position:"fixed", top:0, left:0, bottom:0, right:CHAT_W, background:"#fff", fontFamily:FONT, zIndex:100, overflowY:"auto" }}>
      ...
      {idx === 0 && (
        <div style={{ position:"relative", zIndex:1, padding:"28px 52px 100px", display:"grid", gridTemplateColumns:"1fr 1fr", gap:32, alignItems:"center", maxWidth:1280, margin:"0 auto" }}>
          <div>
            ...
            <div style={{ fontFamily:FONT, fontWeight:900, fontSize:56, color:INK, lineHeight:0.95, marginBottom:14 }}>Graphing<br/>Linear<br/>Functions</div>
        ...
        <div style={{ position:"relative", zIndex:1, padding:"36px 52px 140px", display:"grid", gridTemplateColumns:"1fr 1fr", gap:32, alignItems:"center", maxWidth:1280, margin:"0 auto" }}>
          <div>
            ...
            <div style={{ display:"flex", alignItems:"center", gap:28, marginBottom:18 }}>
              <div style={{ fontFamily:FONT, fontWeight:900, fontSize:56, color:INK, lineHeight:0.92 }}>Graphing<br/>Linear<br/>Functions</div>
      ...
      {idx === 9 || idx === 20 ? null : isLast ? (
        ...
        if (isMultiSlide) {
          ...
          return (
            <div style={{ position:"fixed", bottom:0, left:0, right:CHAT_W, zIndex:10, padding:"18px 52px", display:"flex", alignItems:"center", justifyContent:"flex-end", gap:24, background: multiAllCorrect ? GREENBG : "#FDECEC", borderTop:`2px solid ${multiAllCorrect ? GREEN : RED}` }}>
