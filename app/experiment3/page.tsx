...
export default function Experiment3Page() {
  ...
  // correct answers per practice step
  ...
  return (
    <>
    <ChatPanel top={57} />
    <div style={{ minHeight:"100vh", background:"#fff", fontFamily:FONT, position:"relative", marginRight: CHAT_W }}>
      ...
      {idx === 2 && (
        <div style={{ position:"relative", zIndex:1, padding:"28px 52px 100px", maxWidth:1280, margin:"0 auto" }}>
          ...
          <div style={{ marginBottom:20 }}>
            <div style={{ fontFamily:FONT, fontWeight:600, fontSize:12, color:GRAY, letterSpacing:"0.10em", textTransform:"uppercase", marginBottom:10 }}>Explore</div>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:32, alignItems:"start" }}>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
              ...
              <div style={{ background:"rgba(59,91,219,0.06)", borderRadius:14, padding:"14px 18px", display:"flex", alignItems:"center", gap:14 }}>
                <div style={{ width:38, height:38, borderRadius:"50%", background:ACCENT, display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0 }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><text x="5" y="17" fontFamily="serif" fontSize="16" fontWeight="700" fill="#fff">$</text></svg>
                </div>
              ...
              <div style={{ background:"rgba(59,91,219,0.05)", borderRadius:14, overflow:"hidden" }}>
                <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", borderBottom:"1px solid rgba(59,91,219,0.12)" }}>
                  <div style={{ padding:"12px 24px", fontFamily:FONT, fontWeight:700, fontSize:14, color:INK }}>Hours worked</div>
                  <div style={{ padding:"12px 24px", fontFamily:FONT, fontWeight:700, fontSize:14, color:INK }}>Earnings</div>
                </div>
                {[["1","$15"],["2","$30"],["3","$45"]].map(([h,e],i)=>(
                  <div key={i} style={{ display:"grid", gridTemplateColumns:"1fr 1fr", borderBottom: i<2?"1px solid rgba(59,91,219,0.08)":"none", background:"#fff" }}>
                    ...
                    <div style={{ padding:"14px 24px", fontFamily:FONT, fontSize:18, color:INK, textAlign:"center" }}>{e}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              {/* Options */}
              <OptionList
                options={["The amount it increases by changes each time.", "The amount it increases by stays the same each time."]}
                correct={1}
                picked={picked}
                onPick={setPicked}
              />
      ...
      {idx === 3 && (
        <div style={{ position:"relative", zIndex:1, padding:"28px 52px 100px", maxWidth:1280, margin:"0 auto" }}>
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:32, alignItems:"start" }}>
            ...
            <div>
              <div style={{ fontFamily:FONT, fontWeight:600, fontSize:12, color:GRAY, letterSpacing:"0.10em", textTransform:"uppercase", marginBottom:10 }}>Understand</div>
            ...
            <div style={{ paddingTop:32 }}>
              ...
              <OptionList
                options={["The value is constant", "The change is constant"]}
                correct={1}
                picked={picked}
                onPick={setPicked}
              />
      ...
      {idx === 4 && (
        <div style={{ position:"relative", zIndex:1, padding:"28px 52px 100px", maxWidth:1280, margin:"0 auto" }}>
          ...
          {/* Header */}
          <div style={{ marginBottom:20 }}>
            <div style={{ fontFamily:FONT, fontWeight:600, fontSize:12, color:GRAY, letterSpacing:"0.10em", textTransform:"uppercase", marginBottom:10 }}>Check your understanding</div>
      ...
      {isPractice && (() => {
        const PSLIDES = [
          ...
          {
            emoji:"📱", context:<>A phone plan costs <span style={{color:ACCENT,fontWeight:700}}>$20/month</span> plus <span style={{color:ACCENT,fontWeight:700}}>$5 per GB</span> of data used.</>,
            cols:["GB used","Total Cost"], rows:[["1","$25"],["2","$30"],["3","$35"],["5","$45"],["6","$50"]],
            options:["Yes – linear","No – not linear"], correct:0,
          },
          {
            ...
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:48, alignItems:"start" }}>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
                ...
                <div style={{ borderRadius:14, overflow:"hidden", border:"1px solid rgba(59,91,219,0.10)" }}>
                  <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", background:"rgba(59,91,219,0.05)" }}>
                    {s.cols.map(c=>(
                      <div key={c} style={{ padding:"13px 24px", fontFamily:FONT, fontWeight:700, fontSize:14, color:INK }}>{c}</div>
                    ))}
                  </div>
                  {s.rows.map(([a,b],i)=>(
                    <div key={i} style={{ display:"grid", gridTemplateColumns:"1fr 1fr", borderTop:"1px solid rgba(59,91,219,0.08)", background:"#fff" }}>
      ...
      {idx === 7 || idx === 13 ? null : isLast ? (
        ...
        return (
          <div style={{ background:isCorrect?GREEN:RED, padding:"20px 52px", position:"fixed", bottom:0, left:0, right:CHAT_W, zIndex:10, display:"flex", alignItems:"center", justifyContent:"space-between", gap:24, borderTop:"1px solid rgba(0,0,0,0.08)" }}>
            <div style={{ display:"flex", alignItems:"center", gap:16 }}>
